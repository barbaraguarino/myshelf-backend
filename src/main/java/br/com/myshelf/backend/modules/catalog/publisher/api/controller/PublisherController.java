...
public class PublisherController {
    ...
    @GetMapping
    public ResponseEntity<Page<PublisherResponseDTO>> listAllPublishers(Pageable pageable) {
        return ResponseEntity.status(HttpStatus.OK).body(publisherService.findAllPaged(pageable));
    }
}
